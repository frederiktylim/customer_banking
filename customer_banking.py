...
def main():
    ...
    savings_interest_rate = float(input("Enter the savings account interest rate (annual): "))
    ...
    cd_interest_rate = float(input("Enter the CD account interest rate (annual): "))
